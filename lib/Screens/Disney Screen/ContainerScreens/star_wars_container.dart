...
class StarWarsContainerScreen extends StatefulWidget {
  const StarWarsContainerScreen({Key? key}) : super(key: key);

  @override
  State<StarWarsContainerScreen> createState() =>
      _StarWarsContainerScreenState();
}

class _StarWarsContainerScreenState extends State<StarWarsContainerScreen> {
